...
// example_3Doc.cpp : Cexample_3Doc 类的实现
//
...
// 缩略图的支持
void Cexample_3Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void Cexample_3Doc::InitializeSearchContent()
{
...
void Cexample_3Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
