...
// example_4Doc.cpp : Cexample_4Doc 类的实现
//
...
// 缩略图的支持
void Cexample_4Doc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void Cexample_4Doc::InitializeSearchContent()
{
...
void Cexample_4Doc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
